...
namespace CSharp.Redis
{
    ...
    public interface IRedisHelper
    {
        ...
        void GetDatabase(int dbNumber = 0);
        ...
        /// <returns><see langword="true"/> if the specified member was not already present in the set, else <see langword="false"/>.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geoadd"/></remarks>
        Task<bool> GeoAddAsync<T>(string key, double longitude, double latitude, T member, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns><see langword="true"/> if the specified member was not already present in the set, else <see langword="false"/>.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geoadd"/></remarks>
        Task<bool> GeoAddAsync(string key, GeoEntry value, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The number of elements that were added to the set, not including all the elements already present into the set.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geoadd"/></remarks>
        Task<long> GeoAddAsync(string key, GeoEntry[] values, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns><see langword="true"/> if the member existed in the sorted set and was removed, else <see langword="false"/>.</returns>
        /// <remarks><seealso href="https://redis.io/commands/zrem"/></remarks>
        Task<bool> GeoRemoveAsync<T>(string key, T member, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The command returns the distance as a double (represented as a string) in the specified unit, or <see langword="null"/> if one or both the elements are missing.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geodist"/></remarks>
        Task<double?> GeoDistanceAsync<T>(string key, T member1, T member2, GeoUnit unit = GeoUnit.Meters, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The command returns an array where each element is the Geohash corresponding to each member name passed as argument to the command.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geohash"/></remarks>
        Task<string?[]> GeoHashAsync<T>(string key, T[] members, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The command returns an array where each element is the Geohash corresponding to each member name passed as argument to the command.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geohash"/></remarks>
        Task<string?> GeoHashAsync<T>(string key, T member, CommandFlags flags = CommandFlags.None);
        ...
        /// </returns>
        /// <remarks><seealso href="https://redis.io/commands/geopos"/></remarks>
        Task<GeoPosition?[]> GeoPositionAsync<T>(string key, T[] members, CommandFlags flags = CommandFlags.None);
        ...
        /// </returns>
        /// <remarks><seealso href="https://redis.io/commands/geopos"/></remarks>
        Task<GeoPosition?> GeoPositionAsync<T>(string key, T member, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The results found within the radius, if any.</returns>
        /// <remarks><seealso href="https://redis.io/commands/georadius"/></remarks>
        Task<GeoRadiusResult[]> GeoRadiusAsync<T>(string key, T member, double radius, GeoUnit unit = GeoUnit.Meters, int count = -1, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.Default, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The results found within the radius, if any.</returns>
        /// <remarks><seealso href="https://redis.io/commands/georadius"/></remarks>
        Task<GeoRadiusResult[]> GeoRadiusAsync(string key, double longitude, double latitude, double radius, GeoUnit unit = GeoUnit.Meters, int count = -1, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.Default, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The results found within the shape, if any.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geosearch"/></remarks>
        Task<GeoRadiusResult[]> GeoSearchAsync<T>(string key, T member, GeoSearchShape shape, int count = -1, bool demandClosest = true, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.Default, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The results found within the shape, if any.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geosearch"/></remarks>
        Task<GeoRadiusResult[]> GeoSearchAsync(string key, double longitude, double latitude, GeoSearchShape shape, int count = -1, bool demandClosest = true, Order? order = null, GeoRadiusOptions options = GeoRadiusOptions.Default, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The size of the set stored at <paramref name="destinationKey"/>.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geosearchstore"/></remarks>
        Task<long> GeoSearchAndStoreAsync<T>(string sourceKey, string destinationKey, T member, GeoSearchShape shape, int count = -1, bool demandClosest = true, Order? order = null, bool storeDistances = false, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>The size of the set stored at <paramref name="destinationKey"/>.</returns>
        /// <remarks><seealso href="https://redis.io/commands/geosearchstore"/></remarks>
        Task<long> GeoSearchAndStoreAsync(string sourceKey, string destinationKey, double longitude, double latitude, GeoSearchShape shape, int count = -1, bool demandClosest = true, Order? order = null, bool storeDistances = false, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns></returns>
        bool HashExists(RedisKey key, RedisValue field);
        ...
        /// <returns></returns>
        ConcurrentDictionary<string, string> HashGet(RedisKey key);
        ...
        /// <param name="field">字段</param>
        /// <returns></returns>
        RedisValue HashGet(RedisKey key, RedisValue field);
        ...
        /// <returns></returns>
        ConcurrentDictionary<string, string> HashGetFields(RedisKey key, IEnumerable<string> fields);
        ...
        /// <returns></returns>
        bool HashSet(RedisKey key, RedisValue field, RedisValue value);
        ...
        /// <returns></returns>
        void HashSet(RedisKey key, ConcurrentDictionary<string, string> entries);
        ...
        /// <param name="key"></param>
        /// <param name="fields"></param>
        void HashSetFields(RedisKey key, ConcurrentDictionary<string, string> fields);
        ...
        /// <returns></returns>
        bool HashDelete(RedisKey key, RedisValue field);
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        bool HashDeleteFields(RedisKey key, RedisValue[] fields);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        RedisValue[] HashValues(RedisKey key);
        ...
        /// <param name="field">字段</param>
        /// <returns></returns>
        Task<bool> HashExistsAsync(RedisKey key, string field);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<ConcurrentDictionary<string, string>> HashGetAsync(RedisKey key);
        ...
        /// <param name="field">字段</param>
        /// <returns></returns>
        Task<string> HashGetAsync(RedisKey key, string field);
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        Task<ConcurrentDictionary<string, string>> HashGetFieldsAsync(RedisKey key, IEnumerable<string> fields);
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        Task<bool> HashSetAsync(RedisKey key, string field, string value);
        ...
        /// <param name="entries">字段容器</param>
        /// <returns></returns>
        Task HashSetAsync(RedisKey key, ConcurrentDictionary<string, string> entries);
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        Task HashSetFieldsAsync(RedisKey key, ConcurrentDictionary<string, string> fields);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<bool> HashDeleteAsync(RedisKey key);
        ...
        /// <param name="field"></param>
        /// <returns></returns>
        Task<bool> HashDeleteAsync(RedisKey key, string field);
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        Task<bool> HashDeleteFieldsAsync(RedisKey key, IEnumerable<string> fields);
        ...
        /// <returns></returns>
        long KeyExists(IEnumerable<string> keys);
        ...
        /// <param name="expiry"></param>
        /// <returns></returns>
        bool KeyExpire(RedisKey key, DateTime? expiry);
        ...
        /// <param name="keys"></param>
        /// <returns></returns>
        Task<long> KeyExistsAsync(IEnumerable<string> keys);
        ...
        /// </summary>
        /// <typeparam name="RedisValue"></typeparam>
        /// <param name="key"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        long Enqueue(RedisKey key, RedisValue value);
        ...
        /// <returns></returns>
        long Enqueue<T>(RedisKey key, IEnumerable<T> redisValues);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        T Dequeue<T>(RedisKey key) where T : class;
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        RedisValue[] ListRange(RedisKey key);
        ...
        IEnumerable<T> ListRange<T>(RedisKey key, long start = 0, long stop = -1) where T : class;
        ...
        /// <returns></returns>
        long ListDelRange(RedisKey key, RedisValue value, long type = 0);

        /// <summary>
        /// 清空指定key 的 List
        /// </summary>
        /// <param name="key"></param>
        void ListClear(RedisKey key);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<long> EnqueueAsync(RedisKey key, RedisValue value);
        ...
        /// <returns></returns>
        Task<long> EnqueueAsync<T>(RedisKey key, IEnumerable<T> values);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<T> DequeueAsync<T>(RedisKey key) where T : class;
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<RedisValue[]> ListRangeAsync(RedisKey key);
        ...
        /// <typeparam name="T">对象类型</typeparam>
        /// <returns>不指定 start、end 则获取所有数据</returns>
        Task<IEnumerable<T>> ListRangeAsync<T>(RedisKey key, long start = 0, long stop = -1) where T : class;
        ...
        /// <param name="type">大于零 : 从表头开始向表尾搜索，小于零 : 从表尾开始向表头搜索，等于零：移除表中所有与 VALUE 相等的值</param>
        /// <returns></returns>
        Task<long> ListDelRangeAsync(RedisKey key, RedisValue value, long type = 0);

        /// <summary>
        /// 清空指定key 的 List
        /// </summary>
        /// <param name="key"></param>
        Task ListClearAsync(RedisKey key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        long StringLength(RedisKey key);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        bool StringSetNx(RedisKey key, RedisValue value);
        ...
        /// <returns>The value of key, or nil when key does not exist.</returns>
        /// <remarks><seealso href="https://redis.io/commands/get"/></remarks>
        T StringGet<T>(RedisKey key); // where T : class;
        ...
        /// <seealso href="https://redis.io/commands/incr"/>
        /// </remarks>
        long StringIncrement(RedisKey key, int value = 1);
        ...
        /// <seealso href="https://redis.io/commands/decr"/>
        /// </remarks>
        long StringDecrement(RedisKey key, int value = 1);
        ...
        /// <returns>The length of the string after the append operation.</returns>
        /// <remarks><seealso href="https://redis.io/commands/append"/></remarks>
        long StringAppend(RedisKey key, string value);
        ...
        /// <returns>The substring of the string value stored at key.</returns>
        /// <remarks><seealso href="https://redis.io/commands/getrange"/></remarks>
        string StringGetRange(RedisKey key, int start, int end);
        ...
        /// <inheritdoc cref="StringBitPositionAsync(RedisValue, bool, long, long, StringIndexType, CommandFlags)" />
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        Task<long> StringLengthAsync(RedisKey key);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<bool> StringSetNxAsync(RedisKey key, RedisValue value);
        ...
        /// <returns>The value of key, or nil when key does not exist.</returns>
        /// <remarks><seealso href="https://redis.io/commands/get"/></remarks>
        Task<T> StringGetAsync<T>(RedisKey key); // where T : class;
        ...
        /// <seealso href="https://redis.io/commands/incr"/>
        /// </remarks>
        Task<long> StringIncrementAsync(RedisKey key, int value = 1);
        ...
        /// <seealso href="https://redis.io/commands/decr"/>
        /// </remarks>
        Task<long> StringDecrementAsync(RedisKey key, int value = 1);
        ...
        /// <returns>The length of the string after the append operation.</returns>
        /// <remarks><seealso href="https://redis.io/commands/append"/></remarks>
        Task<long> StringAppendAsync(RedisKey key, string value);
        ...
        /// <returns>The substring of the string value stored at key.</returns>
        /// <remarks><seealso href="https://redis.io/commands/getrange"/></remarks>
        Task<string> StringGetRangeAsync(RedisKey key, int start, int end);
        ...
        /// <returns>The number of members that were removed from the set, not including non existing members.</returns>
        /// <remarks><seealso href="https://redis.io/commands/srem"/></remarks>
        long SetRemove<T>(string key, IEnumerable<T> values);
        ...
        /// <returns>All elements of the set.</returns>
        /// <remarks><seealso href="https://redis.io/commands/smembers"/></remarks>
        IEnumerable<T> SetMembers<T>(string key) where T : class;
        ...
        /// <returns>The number of members removed from the sorted set, not including non existing members.</returns>
        /// <remarks><seealso href="https://redis.io/commands/zrem"/></remarks>
        long SortedSetRemove(string key, IEnumerable<string> members);
        ...
        /// <returns></returns>
        ConcurrentDictionary<string, double> SortedSetRangeByRankWithScores(string key,
            long start = 0,
            long stop = -1,
            Order order = Order.Ascending);
        ...
        /// <seealso href="https://redis.io/commands/zrevrangebyscore"/>
        /// </remarks>
        ConcurrentDictionary<string, double> SortedSetRangeByScoreWithScores(string key,
        ...
        void ExecuteBatch(params Action[] operations);
